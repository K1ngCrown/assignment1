...
public class Spaceship : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Matrix3x3 Translate = IGB283Transform.Translate(offset);
        Matrix3x3 Rotate = IGB283Transform.Rotate(theta * Time.deltaTime);
        Matrix3x3 Translate_Back = IGB283Transform.Translate(-offset);
        Matrix3x3 Transformation = Translate * Rotate * Translate_Back;
